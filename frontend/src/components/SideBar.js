...
const SideBar = () => {
  ...
  const menuItems = [
    ...
    { title: 'Tools Products', path: '/tools', icon: <PiBowlFoodFill /> },
    { title: 'Parts Products', path: '/parts', icon: <CiBowlNoodles /> },
    { title: 'Hardware Products', path: '/hardware', icon: <CiWheat /> },
